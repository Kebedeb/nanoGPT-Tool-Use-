...
wandb_run_name = 'addition-basic'

# data
dataset = 'addition_tools'
train_bin = 'data/addition_tools/train_basic.bin'
val_bin = 'data/addition_tools/val_basic.bin'
meta_path = 'data/addition_tools/train_basic_meta.pkl'
