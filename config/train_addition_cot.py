...
wandb_run_name = 'addition-cot'

# data
dataset = 'addition_tools'
train_bin = 'data/addition_tools/train_cot.bin'
val_bin = 'data/addition_tools/val_cot.bin'
meta_path = 'data/addition_tools/train_cot_meta.pkl'
